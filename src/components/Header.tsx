    ...
    <header className="relative h-96 w-full">
      ...
      <div className="relative z-10 flex h-full items-center justify-center ">
        <div className="text-center px-4 ">
          ...
          <p className="mt-4 text-xl drop-shadow-md md:text-2xl bg-gradient-to-r from-rose-300 to-blue-300 text-transparent bg-clip-text">Building Ideas, Powering Innovation</p>
        </div>
      </div>
    </header>
