    ...
    <div className="w-full bg-gradient-to-b from-slate-950 to-slate-900 text-orange-50 py-12 px-4 md:px-8 shadow-xl">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div className="bg-slate-950/50 p-6 rounded-lg border border-slate-800 hover:bg-slate-800/50 transition-colors">
        ...
        <div className="bg-slate-900/60 p-6 rounded-lg border border-slate-700 text-center">
          ...
          <button className="bg-slate-700 hover:bg-slate-600 text-white font-medium py-2 px-6 rounded-full transition-colors shadow-lg">
